...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String username,  String email,  DateTime createdAt,  DateTime updatedAt,  String password,  String role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String username,  String email,  DateTime createdAt,  DateTime updatedAt,  String password,  String role)  $default,) {final _that = this;
switch (_that) {
case _AccountModel():
return $default(_that.id,_that.username,_that.email,_that.createdAt,_that.updatedAt,_that.password,_that.role);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String username,  String email,  DateTime createdAt,  DateTime updatedAt,  String password,  String role)?  $default,) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.id,_that.username,_that.email,_that.createdAt,_that.updatedAt,_that.password,_that.role);case _:
  return null;
