...
class AppPallete {
  ...
  static const Color blackColor = Color(
    0xFF121212,
  ); // Spotify's main dark background
  static const Color greyColorDark = Color(
    0xFF181818,
  ...
  static const Color greyColorLight = Color(
    0xFF9A9A9A,
  ); // Lighter grey for hints, etc.
  static const Color blackColorLight = Color(
    0xFF282828,
  ); // Even lighter dark grey for cards/elements
  ...
  static const Color lightGreyText = Color(
    0xFF666666,
  ); // Medium grey for less important text in light mode
  ...
  static const Color gradient1 = Color.fromRGBO(
    ...
    84,
    1,
  ); // Spotify Green (same as greenColor for consistency)
  static const Color gradient2 = Color.fromRGBO(
    173,
    232,
    182,
    1,
  ); // Lighter Greenish gradient (adjust if needed)
